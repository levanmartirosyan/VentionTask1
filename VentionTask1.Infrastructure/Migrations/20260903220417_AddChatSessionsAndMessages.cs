        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatSessions_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatSessions_Users_ParticipantOneId",
                        column: x => x.ParticipantOneId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatSessions_Users_ParticipantTwoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatSessions_OrganizationId_ParticipantOneId_ParticipantTwo~",
                table: "ChatSessions",
                columns: new[] { "OrganizationId", "ParticipantOneId", "ParticipantTwoId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChatSessions_ParticipantOneId",
                table: "ChatSessions",
                column: "ParticipantOneId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatSessions_ParticipantTwoId",
                table: "ChatSessions",
