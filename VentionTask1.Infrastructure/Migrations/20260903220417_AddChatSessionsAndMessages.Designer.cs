...
namespace VentionTask1.Infrastructure.Migrations
{
    ...
    [Migration("20260903220417_AddChatSessionsAndMessages")]
    partial class AddChatSessionsAndMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VentionTask1.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VentionTask1.Domain.Entities.ChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "ParticipantOneId", "ParticipantTwoId")
                        .IsUnique();

                    b.ToTable("ChatSessions", (string)null);
                });

            modelBuilder.Entity("VentionTask1.Domain.Entities.FileChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VentionTask1.Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("VentionTask1.Domain.Entities.ChatSession", "ChatSession")
                        .WithMany("Messages")
                        .HasForeignKey("ChatSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VentionTask1.Domain.Entities.User", "Sender")
            ...
            modelBuilder.Entity("VentionTask1.Domain.Entities.ChatSession", b =>
                {
                    ...
                    b.HasOne("VentionTask1.Domain.Entities.User", "ParticipantOne")
                        .WithMany("ParticipantOneChatSessions")
                        .HasForeignKey("ParticipantOneId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("VentionTask1.Domain.Entities.User", "ParticipantTwo")
                        .WithMany("ParticipantTwoChatSessions")
            ...
            modelBuilder.Entity("VentionTask1.Domain.Entities.FileChunk", b =>
                {
                    b.HasOne("VentionTask1.Domain.Entities.UploadedFile", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("VentionTask1.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("ParticipantOneChatSessions");

                    b.Navigation("ParticipantTwoChatSessions");
